...
public class EmployeeTest {
    public static void main(String[] args)
    {
        ...
        switch(choice)
            {
                case 1:
                  if(empCount >= employees.length ){System.out.println("Employee list is full!!");break;}
                  else{
                    sc.nextLine();
                    ...
                    MyDate DOJ = new MyDate(jd, jm, jy);

                    employees[empCount++] = new Employee(name, DOB, id, depart, salary, DOJ);
                ...
                case 4:
                    ...
                    for(int i=0; i<empCount; i++)
                    {
                        if(employees[i].getDOJ().getYear() == searchYear)
                        {
                            System.out.println(employees[i]);
                            found = true;
                            break;
